      ...
      <div className="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex justify-center space-x-6">
            ...
            >
              <svg
                className="inline fill-current sm:w-6 sm:h-6 hover:text-blue-400"
            ...
            >
              <svg
                className="inline text-gray-100 fill-current sm:w-6 sm:h-6 hover:text-gray-400"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
              >
                <title>GitHub</title>
            ...
            >
              <svg
                className="inline text-white rounded-sm fill-current sm:w-6 sm:h-6 hover:text-blue-500"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
